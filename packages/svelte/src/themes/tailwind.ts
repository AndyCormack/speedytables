 ...
 * structure and skin both live in these class strings.
 *
...
export const tailwindTheme: PartClasses = {
	...
	headerLabel:
		'flex min-w-0 flex-1 cursor-pointer items-center gap-1 bg-transparent px-2.5 leading-[30px] font-semibold text-zinc-100 transition-colors hover:bg-zinc-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sky-400/50',
	sortIndicator: 'text-[9px] text-sky-400',
	headerFilter: 'flex min-h-[30px] items-center gap-1 px-1.5 pb-1.5',
	filterInput:
		'h-6 w-full min-w-0 rounded-md border border-zinc-700 bg-zinc-950 px-2 text-xs text-zinc-100 transition-colors placeholder:text-zinc-500 hover:border-sky-400 focus-visible:border-sky-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/40',
	filterClear:
		'absolute top-1/2 right-1 grid h-4 w-4 -translate-y-1/2 cursor-pointer place-items-center rounded-full text-[13px] leading-none text-zinc-400 hover:bg-zinc-700 hover:text-zinc-100',
	enumTrigger:
		'flex h-6 w-full min-w-0 cursor-pointer items-center justify-between gap-1.5 rounded-md border border-zinc-700 bg-zinc-950 px-2 text-left text-xs text-zinc-100 transition-colors hover:border-sky-400 focus-visible:border-sky-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/40 data-active:border-sky-400 data-active:bg-sky-950',
	enumPanel:
	...
	enumReset:
		'cursor-pointer rounded-sm px-1 py-0.5 text-[11px] text-sky-400 hover:bg-sky-950 disabled:cursor-default disabled:text-zinc-600',
	menuTrigger:
		'mr-1.5 h-6 w-5 flex-none cursor-pointer rounded-md text-zinc-400 opacity-0 transition-opacity group-hover:opacity-100 hover:bg-zinc-800 hover:text-zinc-100 focus-visible:opacity-100',
	menuPanel:
		'rounded-lg border border-zinc-700 bg-zinc-900 p-1 text-xs text-zinc-100 shadow-xl shadow-black/40',
	menuItem:
		'flex w-full cursor-pointer items-center gap-2 rounded-md px-2 py-1 text-left whitespace-nowrap hover:bg-zinc-800',
	resizeHandle:
	...
	row: 'border-b border-zinc-800/60 bg-zinc-950 hover:bg-zinc-900',
